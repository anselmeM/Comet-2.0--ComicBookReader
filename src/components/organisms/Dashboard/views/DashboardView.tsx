    ...
    <div className="space-y-8 md:space-y-12 animate-in fade-in duration-500 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-8">
        ...
        <section className="lg:col-span-8 relative h-[300px] md:h-[400px] rounded-3xl md:rounded-[2.5rem] overflow-hidden group shadow-2xl">
          ...
          <div className="absolute inset-0 p-6 md:p-12 flex flex-col justify-end">
            <div className="space-y-2 md:space-y-4 max-w-xl">
              <span className="text-[10px] md:text-xs font-black uppercase tracking-[0.3em] text-blue-400">
              ...
              {featuredComic && (
                <Link
                  ...
                  className="bg-blue-500 hover:bg-blue-600 text-white px-6 md:px-10 py-3 md:py-4 rounded-full font-black text-[10px] md:text-sm uppercase tracking-widest transition-all shadow-xl shadow-blue-500/30 active:scale-95 w-fit mt-2 md:mt-4 flex items-center gap-2"
                >
                  Read Now
                </Link>
              )}
        ...
        <section className="lg:col-span-4 bg-[#0F172A] rounded-3xl md:rounded-[2.5rem] p-6 md:p-10 text-white flex flex-col justify-between shadow-2xl relative overflow-hidden group">
          ...
          >
            ...
            <div className="w-10 h-10 md:w-12 md:h-12 bg-white/5 rounded-xl md:rounded-2xl flex items-center justify-center group-hover/btn:bg-blue-500 transition-all">
      ...
      <section className="space-y-4 md:space-y-8">
        ...
        <div className="flex flex-wrap gap-4 md:gap-8 justify-between md:justify-start">
          ...
          >
            <div className="w-16 h-16 md:w-24 md:h-24 rounded-full bg-neutral-100 flex items-center justify-center border-2 border-dashed border-neutral-200 transition-all group-hover:border-blue-500 group-hover:bg-blue-50 group-hover:text-blue-500">
              <Users
                className="w-6 h-6 md:w-8 md:h-8 text-neutral-300 group-hover:text-blue-500"
                strokeWidth={1.5}
              />
            </div>
            <span className="text-[9px] md:text-[10px] font-black text-neutral-300 uppercase tracking-widest group-hover:text-blue-500 transition-colors">
              View All
            </span>
          </div>
        </div>
      ...
      <section className="space-y-4 md:space-y-8">
        <div className="flex items-center justify-between">
          ...
          <button className="text-[10px] md:text-xs font-black uppercase tracking-widest text-blue-500 hover:underline">
            View All
          </button>
        </div>
          ...
          {topRatedComics.map((comic) => (
            <div key={comic.id} className="group flex flex-col gap-2 md:gap-4">
              ...
              <div className="flex flex-col gap-0.5 md:gap-1">
                <h4 className="text-xs md:text-sm font-black text-blue-600 group-hover:underline decoration-2 underline-offset-2 cursor-pointer line-clamp-1">
                  {comic.title}
                </h4>
        ...
        <div className="flex items-center justify-between border-t border-neutral-100 pt-8 md:pt-12">
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <button
              ...
              className={`flex items-center gap-1.5 md:gap-2 px-3 md:px-5 py-1.5 md:py-2 rounded-full text-[10px] md:text-xs font-black uppercase tracking-widest transition-all ${isEditMode ? 'bg-blue-500 text-white shadow-lg shadow-blue-500/20' : 'bg-neutral-100 text-neutral-400 hover:bg-neutral-200'}`}
            >
