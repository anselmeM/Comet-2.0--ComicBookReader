...
import { Settings, ArrowLeft, Sun, Columns, File, Maximize, AlignRight } from 'lucide-react';
    ...
    <div className="flex flex-col gap-4 w-full bg-neutral-900/90 backdrop-blur-md p-4 rounded-3xl text-white pointer-events-auto border border-neutral-800 shadow-xl mb-4 max-w-2xl mx-auto">
      ...
      <div className="flex items-center justify-between mt-2 flex-wrap gap-4">
        ...
        <div className="flex items-center gap-1 bg-neutral-800 p-1 rounded-xl">
          ...
          />
          <ModeButton 
            active={readingMode === 'guided-view'} 
            onClick={() => setReadingMode('guided-view')}
        ...
        <div className="flex items-center gap-2 flex-1 max-w-[150px]">
          ...
          <input
            ...
            className="w-full h-1 bg-neutral-700 rounded-full appearance-none accent-yellow-500"
          />
        </div>
      </div>
    </div>
